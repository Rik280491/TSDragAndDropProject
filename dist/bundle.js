...
define("components/project-list", ["require", "exports", "models/project-model", "components/base-component", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, project_model_js_2, base_component_js_3, autobind_js_3, project_state_js_2, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        configure() {
            ...
            project_state_js_2.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((proj) => {
                    if (this.type === "active") {
                        return proj.status === project_model_js_2.ProjectStatus.Active;
                    }
                    return proj.status === project_model_js_2.ProjectStatus.Finished;
                });
